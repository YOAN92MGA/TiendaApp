# ui/pos_window.py - Versión definitiva con diseño moderno y carrito visible
...
class POSWindow(QWidget):
    def __init__(self, db: Session, user):
        ...
        self.setMinimumSize(1100, 700)  # Aumentado para que el carrito se vea completo
        ...
        # Categorías en vertical (una columna)
        ...
        categories = ["Todos", "Calzado", "Liquidos", "Carnicos", "Confituras", "Granos", "Ropas", "Piezas de Moto",
        ...
        for cat in categories:
            ...
            btn.setMinimumWidth(120)  # Ancho fijo para que no se corten
            btn.setStyleSheet("""
                QPushButton {
        ...
        # Envolver en un scroll (opcional, útil si hay muchas categorías)
        category_scroll = QScrollArea()
        category_scroll.setWidgetResizable(True)
        category_scroll.setFrameShape(QFrame.NoFrame)
        category_scroll.setWidget(self.category_widget)
        category_scroll.setMaximumWidth(150)  # Ancho fijo para la columna de categorías
        ...
        splitter.setSizes([850, 550])  # Izquierda más ancha, derecha suficiente
